...
SECRET_KEY = 'django-insecure-yv!jl856dk$+*x06sagndgy^(sz_!h6+sy$3h1#ulh#v9krey#'
...
LECTURES_DB_PATH = BASE_DIR / 'lectures_FS2026.db'
EMBEDDINGS_DB_PATH = BASE_DIR / 'embeddings_FS2026.db'
